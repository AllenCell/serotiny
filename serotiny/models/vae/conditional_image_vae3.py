...
class ConditionalImageVAE3(BaseVAE):
    def __init__(
        self,
        ...
        self.flat_layers = [nn.Flatten(), MLP(flat_dim + self.num_classes, latent_dim*2, hidden_layers=linear_hidden_layers)]
    ...
    def encode(self, x, **kwargs):
        ...
        kwargs['condition'] = onehot_condition
        _tmp = self.encoder(
