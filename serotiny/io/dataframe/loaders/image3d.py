...
class Load3DImage(Loader):
    """
    Loader class, used to retrieve 3d images from paths given in a dataframe column
    """
    ...
    def __init__(
        ...
        file_type: str
            ...
            only supported format. But in the future other
            formats (like zarr) might be supported too

        select_channels: Optional[Sequence] = None
            List of channels to load. If nothing is provided,
            all the available channels are loaded
