...
6. Commit your changes and push your branch to GitHub:
    ...
    git push -u origin {your_development_type}/short-description
    ```

7. Submit a pull request through the GitHub website. Your PR should be submitted against the `dev` branch
